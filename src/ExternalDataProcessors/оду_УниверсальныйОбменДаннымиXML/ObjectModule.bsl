...
// ▼ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▼ Начало
Перем оду_СтекНеЗаписанныхОбъектов;
Перем оду_ДокументыДляОтложенногоПроведения; // Таблица значений для проведения документов после загрузки данных.
// ▲ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▲ Конец 
...
Процедура ЗаписатьИнформациюОбОшибкеЗагрузкиОбработчикаПКО(КодСообщения, СтрокаОшибки, ИмяПравила, Источник,
	...
	// ▼ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▼ Начало
	оду_ЗафиксироватьОшибку(Источник, СтрокаСообщенияОбОшибке);
	// ▲ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▲ Конец 
...
Процедура ЗаписатьИнформациюОбОшибкеОбработчикаОчисткиДанных(КодСообщения, СтрокаОшибки, ИмяПравилаОчисткиДанных, Объект = "", ИмяОбработчика = "")
	...
	// ▼ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▼ Начало
	оду_ЗафиксироватьОшибку(Объект, СтрокаСообщенияОбОшибке);
	// ▲ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▲ Конец 
...
Процедура ЗаписатьИнформациюОбОшибкеОбработчикиПВД(КодСообщения, СтрокаОшибки, ИмяПравила, ИмяОбработчика, Объект = Неопределено)
	...
	// ▼ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▼ Начало
	оду_ЗафиксироватьОшибку(Объект, СтрокаСообщенияОбОшибке, Истина);
	// ▲ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▲ Конец 
			...
			Иначе
				...
				Если Не ПустаяСтрока(Значение) Тогда
					...
					Исключение
						...
						// ▼ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▼ Начало
						оду_ЗафиксироватьОшибку(НоваяСтрока.Источник, ОписаниеОшибки());
						// ▲ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▲ Конец 
...
Процедура ВосстановитьПравилаИзВнутреннегоФормата() Экспорт
	...
	Если РежимОбмена = "Выгрузка" Тогда
		...
		// ▼ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▼ Начало
		оду_ЗафиксироватьОшибку(Источник, ОписаниеОшибки());
		// ▲ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▲ Конец 
...
Функция СоздатьНовыйОбъект(Тип, СвойстваПоиска, Объект = Неопределено, 
	...
	//// ▼ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▼ Начало
	//оду_ДобавитьВСписокНеЗаписанныхОбъектов(НоваяСсылка);
	//// ▲ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▲ Конец 
	...
	Если ЗаписыватьОбъектСразуПослеСоздания Тогда
		...
		Иначе
			...
			//// ▼ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▼ Начало
			//оду_ДобавитьВСписокНеЗаписанныхОбъектов(НоваяСсылка, Правило.Имя);
			//// ▲ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▲ Конец 
		...
		ИначеЕсли ИмяУзла = "Ссылка" Тогда
			...
			Иначе
				...
				Если Ссылка = Неопределено Тогда
					...
					// ▼ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▼ Начало
					оду_ДобавитьВСписокНеЗаписанныхОбъектов(ИзвестнаяСсылкаУникальногоИдентификатора, Правило.Имя);
					// ▲ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▲ Конец 
		...
		ИначеЕсли (ИмяУзла = "Объект") И (ФайлОбмена.ТипУзла = одТипУзлаXML_КонецЭлемента) Тогда
			...
			Если ИмяТипаОбъекта = "Документ" Тогда
				...
				Исключение
					...
					// ▼ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▼ Начало
					оду_ЗафиксироватьОшибку(Объект, ОписаниеОшибки());
					// ▲ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▲ Конец 
...
Функция ПроверитьСуществованиеСсылки(Ссылка, Менеджер, НайденныйОбъектПоУникальномуИдентификатору,
	...
	Попытка
		...
		Если ПустаяСтрока(СтрокаЗапросаПоискаПоУникальномуИдентификатору) Тогда
			...
			//	
			//КонецЕсли;
			оду_СсылкаСуществует = пр_Общий.СсылкаСуществует(Ссылка);
			Если оду_СсылкаСуществует = Ложь Тогда
				Возврат Менеджер.ПустаяСсылка();
			КонецЕсли; 
			// ▲ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▲ Конец 
...
Функция ВыполнитьДействияПередЧтениемДанных(СтрокаДанных = "") Экспорт
	...
	// ▼ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▼ Начало
	оду_СтекНеЗаписанныхОбъектов = Новый Массив;
	// ▲ ayan#мпп#bitrix2289 Быстрый и эффективный обмен УТАП - УТ - УТАП  КирилловПС  2023.06.05 ▲ Конец 
...
//  Нет.
//
Процедура ВыполнитьЗагрузку(оду_РезультирующаяСтрокаСИнформациейОбОшибке = "") Экспорт
	...
	Попытка
		ПроизвестиЧтениеДанных(оду_РезультирующаяСтрокаСИнформациейОбОшибке);
		
		оду_ЗаписатьНеЗаписанныеОбъекты();
		...
		Данные.Вставить("оду_ДокументыДляОтложенногоПроведения", оду_ДокументыДляОтложенногоПроведения);
	...
	Попытка
		...
		Если Не Отказ Тогда
			...
			Если Не Отказ Тогда
				...
				//АЯН
				Если Комментарий = "оду_ВыгрузкаИзРегистрации" Тогда
					УдачноВыгруженоПоПланамОбмена = оду_ОбработатьПравилаВыгрузки();		
				Иначе
...
Функция оду_ОбработатьПравилаВыгрузки()
	...
	Иначе
		//По данным
		УдачнаяВыгрузка = оду_ВыполнитьВыгрузкуПоДанным();
	КонецЕсли;
...
//   Данные - ЛюбаяСсылка - ссылка справочника, документа, ключ регистра сведений и т.д.
//
Процедура оду_ПолучитьСтрокуПравилВыгрузкиПоОбъектуОбмена(ТекДанные, МетаданныеПоследнегоОбъекта, МетаданныеОбъектаВыгрузки, 
	ПоследняяСтрокаПравилВыгрузки, ТекущаяСтрокаПравилаВыгрузки, МассивПравилКонвертации, ОбъектДляПравилВыгрузки, 
	ВыгружаетсяРегистр, ВыгружаютсяКонстанты, КонстантыБылиВыгружены)
	...
	Если СтруктураДанных.ЭтоСсылочныйТип = Истина Тогда
		...
		ОбъектДляПравилВыгрузки = ТекДанные.Ссылка;
		
	ИначеЕсли СтруктураДанных.ЭтоРегистр = Истина Тогда
		
		ОбъектДляПравилВыгрузки = ТекДанные;
...
Процедура оду_ЗаполнитьПараметры(Ключ, Значение)
	
	Параметры[Ключ] = Значение;
	
	//Отбор = Новый Структура("Имя", Ключ);
	//МассивСтрок = ТаблицаНастройкиПараметров.НайтиСтроки(Отбор);
	//
	//Если МассивСтрок.Количество() > 0 Тогда
	//	СтрокаПараметра = МассивСтрок[0];
	//	СтрокаПараметра.Значение = Значение;
	//КонецЕсли;
	
КонецПроцедуры

Функция оду_ВыполнитьВыгрузкуПоДанным()
	
	Попытка
		
		СоответвиеПараметровВыгрузки = Данные.СоответвиеПараметровВыгрузки;
		ТекущаяСтрокаПравилаВыгрузки = Данные.ТекущаяСтрокаПравилаВыгрузки;
		ТаблицаСостоянийОбмена 		 = Данные.ТаблицаСостоянийОбмена;

		
		Для каждого Стр Из СоответвиеПараметровВыгрузки Цикл
			
			// 01. Передача параметров
			оду_ТипСсылки = Стр.Ключ;
			оду_СтруктураДанных = Стр.Значение;
			
			//ПередачаПараметров
			//ТипСсылки = "CatalogRef.СерииНоменклатуры"
			ИмяПКО = СтрРазделить(оду_ТипСсылки, ".")[1];
			оду_ЗаполнитьПараметры("ТипСсылки", ИмяПКО);
			оду_ЗаполнитьПараметры("МассивСсылок1С", оду_СтруктураДанных.ОбъектДляПравилВыгрузки);
			оду_ЗаполнитьПараметры("ПереносТолькоСсылок", оду_СтруктураДанных.ПереносТолькоСсылок);
			
			ВыгрузитьДанныеПоПравилу(ТекущаяСтрокаПравилаВыгрузки);
...
Процедура оду_ДобавитьВСписокНеЗаписанныхОбъектов(оду_Ссылка, ИмяПравила)
	
	Попытка
		
		//Если Лев(ИмяПравила,2) = "л_" Тогда
		Если Лев(ИмяПравила,3) = "зс_" Тогда  //Запрос ссылки
			оду_СтекНеЗаписанныхОбъектов.Добавить(оду_Ссылка);	
		КонецЕсли; 
		
	Исключение
		СтрокаСообщенияОбОшибке = ОписаниеОшибки();
		оду_Общий.ОтправитьСообщениеВТелеграмExchange("оду_УниверсальныйОбменДаннымиXML.оду_ДобавитьВСписокНеЗаписанныхОбъектов", , СтрокаСообщенияОбОшибке);	
	КонецПопытки;
	
КонецПроцедуры

Процедура оду_ЗаписатьНеЗаписанныеОбъекты()
	
	Если оду_СтекНеЗаписанныхОбъектов.Количество() = 0 Тогда
		Возврат;	
	КонецЕсли; 
	...
	//Попытка
		...
		Для каждого оду_Ссылка Из оду_СтекНеЗаписанныхОбъектов Цикл
		//Для каждого СтруктураПараметров Из оду_СтекНеЗаписанныхОбъектов Цикл
			//оду_Ссылка = СтруктураПараметров.ИзвестнаяСсылка;
			Если НЕ пр_Общий.СсылкаСуществует(оду_Ссылка)  Тогда
				Продолжить;			
			КонецЕсли; 
			Нстр = ТЗ.Добавить();
			ЗаполнитьЗначенияСвойств(Нстр, Данные); 
			//Нстр.Ссылка = оду_Ссылка;
			Нстр.ИДОбъекта = XMLСтрока(оду_Ссылка);
			Нстр.ТипXMLОбъектаИсточника = пр_Общий.ИмяТипаXMLПоСсылке(оду_Ссылка);
		...
		Запрос.Текст = 
			...
			|	ДАТАВРЕМЯ(1, 1, 1) КАК ДатаВыгрузки,
			|	"""" КАК ИмяФайлаОбмена,
			|	33 КАК ПриоритетОбмена,
			|	ЕСТЬNULL(оду_БазыУчастникиОбменаСостав.НомерСтроки, 1) КАК ПриоритетОбъекта,
			|	0 КАК ПриоритетДопПризнака,
			|	0 КАК НомерПопытки,
			|	&КонфигурацияКД2 КАК КонфигурацияКонвертацииОбмена
			|ИЗ
		...
		Запрос.УстановитьПараметр("КонфигурацияКД2", оду_ОбщийПовтИсп.КонфигурацияКД2());
		...
		ВДЗ.Сбросить();
		оду_МассивДанныхЗапросаСсылки = пр_Общий.МассивСтруктурПоЗапросу(ВДЗ);
		Данные.Вставить("оду_МассивДанныхЗапросаСсылки", оду_МассивДанныхЗапросаСсылки);
	...
	Исключение
		...
		СтрокаСообщенияОбОшибке = ОписаниеОшибки();
		оду_Общий.ОтправитьСообщениеВТелеграмExchange("оду_УниверсальныйОбменДаннымиXML.оду_ЗаписатьНеЗаписанныеОбъекты", , СтрокаСообщенияОбОшибке);	
	КонецПопытки; 
	
КонецПроцедуры

Функция оду_ЗафиксироватьОшибку(Объект = Неопределено, СтрокаСообщенияОбОшибке, ОшибкаВПВД = Ложь)  Экспорт
	Если пр_Общий.ЗаполненноЗначениеРекизитаСвойства(Данные, "ТаблицаСостоянийОбмена") Тогда
		оду_Модуль = пр_НастройкиПовтИсп.ИсполняемыйМодуль("оду_Общий", пр_НастройкиПовтИсп.ТекущийПользователь()); 
		оду_Модуль.оду_РезультатЗаписиОшибкиОбработкиУОД(Данные.ТаблицаСостоянийОбмена, Объект, СтрокаСообщенияОбОшибке, ОшибкаВПВД);	
	Иначе 
		оду_Общий.ОтправитьСообщениеВТелеграмExchange("УниверсальныйОбменДаннымиXML", Объект, СтрокаСообщенияОбОшибке);	
	КонецЕсли; 
КонецФункции 

Функция оду_РезультатДобаленияОбъектаДляОтложенногоПроведения(СсылкаНаОбъект, ИзвестнаяСсылкаУникальногоИдентификатора, ДополнительныеСвойства) Экспорт
	
	Попытка
		оду_ТаблицаОтложенногоПроведения = оду_ДокументыДляОтложенногоПроведения();
		НоваяСтрока = оду_ТаблицаОтложенногоПроведения.Добавить();
		Если ИзвестнаяСсылкаУникальногоИдентификатора = Неопределено Тогда
			оду_Ссылка = СсылкаНаОбъект;	
		Иначе
			оду_Ссылка = ИзвестнаяСсылкаУникальногоИдентификатора;	
		КонецЕсли; 
		
		НоваяСтрока.ДокументСсылка = оду_Ссылка;
		//НоваяСтрока.ДатаДокумента  = ДатаОбъекта;
		НоваяСтрока.ТипXMLОбъектаИсточника = пр_Общий.ИмяТипаXMLПоСсылке(оду_Ссылка);
		//Бывает без ссылки, записываем позже
		//НоваяСтрока.ИДОбъекта = XMLСтрока(СсылкаНаОбъект);
		НоваяСтрока.ДополнительныеСвойства = ЗначениеВСтрокуВнутр(ДополнительныеСвойства);
...
//
Функция оду_ДокументыДляОтложенногоПроведения() 
	
	Если ТипЗнч(оду_ДокументыДляОтложенногоПроведения) <> Тип("ТаблицаЗначений") Тогда
		
		// Инициализируем таблицу для отложенного проведения документов.
		оду_ДокументыДляОтложенногоПроведения = Новый ТаблицаЗначений;
		оду_ДокументыДляОтложенногоПроведения.Колонки.Добавить("ДокументСсылка");
		//оду_ДокументыДляОтложенногоПроведения.Колонки.Добавить("ДатаДокумента", одОписаниеТипа("Дата"));
		оду_ДокументыДляОтложенногоПроведения.Колонки.Добавить("ТипXMLОбъектаИсточника", ОбщегоНазначения.ОписаниеТипаСтрока(150));
		оду_ДокументыДляОтложенногоПроведения.Колонки.Добавить("ИДОбъекта", ОбщегоНазначения.ОписаниеТипаСтрока(40));
		оду_ДокументыДляОтложенногоПроведения.Колонки.Добавить("ДополнительныеСвойства", ОбщегоНазначения.ОписаниеТипаСтрока(1024));
		
	КонецЕсли;
	
	Возврат оду_ДокументыДляОтложенногоПроведения;
