//ВнОбработка ОМ.оду_ОбщийПовтИсп
...
Функция НастройкиУчастникаОбмена(СсылкаУО = Неопределено)  Экспорт 
	...
	Запрос.Текст = 
		...
		|	оду_БазыУчастникиОбмена.ПодчиненныйУчастникОбмена КАК ПодчиненныйУчастникОбмена,
...
Функция ТекстЗапросаПолученияМассиваУчастниковОбменаПоТипуОбъектаИОрганизаций(ЭтоСамолет = Ложь, МассивОрганизаций = Неопределено)
...
Функция МассивУчастниковОбменаПоТипуОбъектаИОрганизаций(ТипXML, НастройкиТекущейБД, ЭтоСамолет = Ложь, МассивОрганизаций = Неопределено) Экспорт
	
	Запрос = Новый Запрос;
	Запрос.Текст = ТекстЗапросаПолученияМассиваУчастниковОбменаПоТипуОбъектаИОрганизаций(ЭтоСамолет, МассивОрганизаций);
