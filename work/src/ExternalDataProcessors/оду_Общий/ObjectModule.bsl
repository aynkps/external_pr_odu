...
Функция ПараметрыРегистрацииУчастниковОбменаПоТипуОбъекта(МассивОбъектовОбмена, ТекущийПользователь = Неопределено, ЭтоСамолет = Ложь, УОД = Неопределено) Экспорт
	...
	МассивУчастниковОбмена = МассивУчастниковОбменаПоТипуОбъектаИОрганизаций(ИмяТипаXML, НастройкиТекущейБД, ЭтоСамолет, МассивОрганизаций, УОД);
...
Функция ВыгрузитьОбъектыУОКД2(ВыборкаНастройкиКонвертации, ИмяФайлаОбмена, ВыборкаУО) Экспорт
	...
	Попытка
		...
		Пока ВыборкаНастройкиКонвертации.Следующий() Цикл
			...
			ВыборкаДополнительныеСвойстваОбъекта = ВыборкаНастройкиКонвертации.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
			
			Пока ВыборкаДополнительныеСвойстваОбъекта.Следующий() Цикл
				
				ДополнительныеСвойстваОбъекта = ВыборкаДополнительныеСвойстваОбъекта.ДополнительныеСвойстваОбъекта;
					...
					Пока ВДЗ.Следующий() Цикл
						...
						Если (Сч = КолОбъектовВОбмене ИЛИ КолТекЭл >= КолОбъектовОбмена) //И ИмяТипаXML_До <> Неопределено 
							...
							СтрокаОтветаОбмена = СтрокаОтветаОбменаВыгрузкуДанныхУОДКД2(ТаблицаСостоянийОбмена, Этап, КолЦиклов, ИмяФайлаОбмена, ИмяТипаXML, МассивСсылок1С, 
													СоответвиеПараметровВыгрузки, ДополнительныеСвойстваОбъекта, ОбработкаОбменаДанных, ПараметрыКонвертации);
							Сч = 0;	
...
Функция СтрокаОтветаОбменаВыгрузкуДанныхУОДКД2(ТаблицаСостоянийОбмена, Этап, КолЦиклов, ИмяФайлаОбмена, ИмяТипаXML,  МассивСсылок1С, СоответвиеПараметровВыгрузки, ДополнительныеСвойстваОбъекта, ОбработкаОбменаДанных, ПараметрыКонвертации)
