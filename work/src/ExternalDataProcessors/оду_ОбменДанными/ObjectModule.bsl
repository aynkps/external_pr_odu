...
Функция МассивОбъектовОбменаСамолетПоОтбору(МассивСсылокНаОбъект, ИмяТипа, ИДКонфигурации)  Экспорт
	
	//TODO:  Дописать индивидуальные настройки отбора
	//Возврат МассивСсылокНаОбъект;
	
	//Пример:
	Если СтрНайти(ИмяТипа, "DocumentRef") > 0  Тогда
		МассивОбъектовОбмена = ПроверитьМассивОбъектовОбмена(МассивСсылокНаОбъект, ИмяТипа, ИДКонфигурации);
	Иначе
		МассивОбъектовОбмена = МассивСсылокНаОбъект;
	КонецЕсли;   
